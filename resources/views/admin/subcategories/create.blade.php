...
@section('title')Add Product Subcategory @endsection
...
<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
    ...
    <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
        ...
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active" aria-current="page">Add Product Subcategory</li>
        </ol>
    ...
    <div class="row no-gutters app-content">
          ...
          <div class="col-md-12 col-xxl-12 mb-3 pr-md-2">
            ...
            <div class="card h-md-100  w-md-d-card">
                <div class="card-body ">
                    <form action="{{ url('dashboard/subcategories/store') }}"class="steps-validation wizard-circle" id="form"  novalidate="" method="POST" enctype="multipart/form-data">
                        @method('PATCH')
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control required" id="name" type="text" name="name" required="" placeholder="Product Subcategory Name" value="">
                                </div>
                            </div>
