...
@section('title')Product Subcategories @endsection
...
<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
    ...
    <h4 class="content-header-title float-left mb-0">Product Subcategories</h4>
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><a href="{{ url('dashboard/subcategories/edit/'.$category->id) }}"><span class="badge bg-primary text-white"><i class="feather icon-edit"></i> Update</span></a></td>
                              </tr>          
                            @endforeach
