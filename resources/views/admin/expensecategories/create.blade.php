    ...
    <div class="row no-gutters app-content">
          ...
          <div class="col-md-12 col-xxl-12 mb-3 pr-md-2">
            ...
            <div class="card h-md-100  w-md-d-card">
                <div class="card-body ">
                    <form action="{{ url('dashboard/expenditures/categories/store') }}" class="steps-validation wizard-circle" id="form" novalidate="" method="POST" enctype="multipart/form-data">
                        @method('PATCH')
                    ...
                    <fieldset>
                        <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control required" id="name" type="text" name="name" required="" placeholder="Category Name" autofocus>
                            </div>
                            </div>
