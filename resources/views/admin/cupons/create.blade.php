    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="row product-adding">
                <div class="col-xl-12">
                    <form action="{{ url('dashboard/cupons/store') }}" class="needs-validation add-product-form" novalidate="" method="POST" enctype="multipart/form-data">
                        @method('PATCH')
                        <div class="form">
                            <div class="form-group mb-3 row">
                                <label for="name" class="col-xl-3 col-sm-4 mb-0">Code :</label>
                                <input class="form-control col-xl-8 col-sm-7" id="code" type="text" name="code" required="" placeholder="Cupon Code">
                            ...
                            <div class="form-group mb-3 row">
                                ...
                                <input class="form-control col-xl-8 col-sm-7" id="discount" type="number" name="discount" required="" placeholder="Example - 15/20/21">
                                <div class="valid-feedback">Looks good!</div>
                            </div>
                            ...
                            <div class="form-group mb-3 row">
                                ...
                                <input class="form-control col-xl-8 col-sm-7" id="starting_at" type="date" name="starting_at" required="">
                                <div class="valid-feedback">Looks good!</div>
                            </div>

                            <div class="form-group mb-3 row">
                                <label for="name" class="col-xl-3 col-sm-4 mb-0">Ending At :</label>
                                <input class="form-control col-xl-8 col-sm-7" id="ending_at" type="date" name="ending_at" required="">
                                <div class="valid-feedback">Looks good!</div>
                            </div>
