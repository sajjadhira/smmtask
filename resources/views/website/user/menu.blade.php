<ul class="list-group left-menu">
    ...
    <br/>
    <li><b>Publisher Menu</b></li>
    <br/>
    <li><a href="{{url('deposit')}}" @if(request()->segments()[0]=='deposit')class="active" @endif>Buy Points</a></li>
    <li><a href="{{url('payments')}}" @if(request()->segments()[0]=='payments')class="active" @endif>Payments</a></li>
