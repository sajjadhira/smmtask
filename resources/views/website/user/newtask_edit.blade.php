...
@section('title'){{__("Editing Task")}}@endsection
...
@section('content')
          ...
          <div class="col-md-12 col-xxl-12 mb-3 pr-md-2">
            ...
            <div class="card h-md-100  w-md-d-card">
                <div class="card-body ">
                    <form action="{{ url('mytasks/update/'.$data['task']->id) }}"   class="steps-validation wizard-circle" id="form" novalidate="" method="POST" enctype="multipart/form-data">
                        @method('PATCH')
                    ...
                    <fieldset>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="name">Current Budget (Points)*</label>
                                <input class="form-control required" id="new_budget" type="number" name="new_budget" min="10" placeholder="500000" value="{{$data['task']->budget}}" readonly>
                            </div>
                            <br/>
                            <br/>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="name">Add Budget (Points)*</label>
                                <input class="form-control required" id="budget" type="number" name="budget" min="100" placeholder="10000" value="" required>
                            </div>
                            <br/>
                            <br/>
                        </div>
