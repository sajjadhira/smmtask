...
@section('title')
<?php  echo \App\Campaigns::findOrFail($data['campaign'])->name  ?> Add Images
@endsection
            ...
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-left mb-0"><?php  echo \App\Campaigns::findOrFail($data['campaign'])->name  ?> Add Images</h2>
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active">Add Image
                                    </li>
                                </ol>
                            </div>
                        </div>
                        ...
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <div class="card-body">
                                        <form method="POST" action="{{ url('images/store') }}" class="steps-validation wizard-circle" id="form" enctype='multipart/form-data'>
                                        	@method('PATCH')
                                            <!-- Step 1 -->
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        ...
                                                        <select class="form-control required" id="code" name="code">
                                                            ...
                                                            @for($i=1;$i<=20;$i++)
                                                            <option value="image-{{$i}}">image-{{$i}}</option>
                                                            @endfor
                                                        </select>
                                                        </div>
                                                    </div>
