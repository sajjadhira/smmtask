...
class DashboardController extends Controller
{
    ...
    public function settings()
    {
        ...
        $data['colors'] = ['0088FF' => 'High Click', '15C39A' => 'Medium Click', 'DB2124' => 'Low Click'];
        ...
        $data['website_button_color'] = $get_website_button_color[0]->value;
    ...
    public function settingsUpdate(Request $request)
    {
        ...
        $get_website_button_color = Settings::where(['name' => 'website_button_color'])->get();
        $website_button_color = Settings::find($get_website_button_color[0]->id);
        $website_button_color->value = $request->website_button_color;
        $website_button_color->save();
